...
from patent_innovation_variables import SAMPLE_EARLIEST_DATE, SAMPLE_LATEST_DATE, SAMPLE_5_YEAR_CUTOFF

RESOURCE_PATH = resources.files("patent_innovation_variables.data.citations")
